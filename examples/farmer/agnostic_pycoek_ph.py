...
def _farmer_parse_args():
    ...
    farmer_pycoek_agnostic.inparser_adder(cfg)
    ...
    cfg.parse_command_line("farmer_pycoek_agnostic_cylinders")
    return cfg
...
if __name__ == "__main__":
    ...
    Ag = agnostic.Agnostic(farmer_pycoek_agnostic, cfg)

    scenario_creator = Ag.scenario_creator
    scenario_denouement = farmer_pycoek_agnostic.scenario_denouement   # should we go though Ag?
